...
function getEmptyBook(title = '', thumbnail = '') {
    return {
        id: '',
        title,
        description: 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptas voluptatibus est deserunt. Autem amet aliquam molestias quos quis sequi aspernatur consectetur blanditiis possimus iusto at fuga animi, omnis molestiae quas!',
        thumbnail,
...
function _createBook(title, thumbnail) {
    const book = getEmptyBook(title, thumbnail)
